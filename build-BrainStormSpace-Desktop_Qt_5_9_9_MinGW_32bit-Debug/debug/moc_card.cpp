...
#include "../../BrainStormSpace/card.h"
...
QT_MOC_LITERAL(3, 15, 6), // "Office"
QT_MOC_LITERAL(4, 22, 21) // "on_seeMoreBtn_clicked"

    },
    "Card\0sendData\0\0Office\0on_seeMoreBtn_clicked"
};
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< Office(*)>(_a[1]))); break;
        ...
        {
            typedef void (Card::*_t)(Office );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Card::sendData)) {
                *result = 0;
                return;
            }
        }
